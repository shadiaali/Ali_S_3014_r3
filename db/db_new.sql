...
--
-- Host: localhost:8889
-- Generation Time: Mar 08, 2019 at 01:12 AM
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_ip`, `user_firstlogin`) VALUES
(1, 'finalusers', 'auser', 'apassword', 'auser@user.com', 'no', '2'),
(24, 'testsss', 'test', 'test', 'test@test.com', 'no', '2');
